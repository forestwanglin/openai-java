...
[![GitHub version](https://img.shields.io/static/v1?label=version&message=v3.8.2024020702&color=blue)](https://github.com/forestwanglin/openai-java)
...
<dependency>
    ...
    <version>3.8.2024020702</version>
</dependency>
```
...
```yaml
implementation group: 'xyz.felh', name: 'service', version: '3.8.2024020702'
implementation group: 'xyz.felh', name: 'jtokkit', version: '3.8.2024020702'
```

### sbt

```javascript
libraryDependencies += "xyz.felh" % "service" % "3.8.2024020702"
libraryDependencies += "xyz.felh" % "jtokkit" % "3.8.2024020702"
```
