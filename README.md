...
```yaml
implementation group: 'xyz.felh', name: 'service', version: '3.7.0304'
implementation group: 'xyz.felh', name: 'jtokkit', version: '3.7.0304'
```

### sbt

```javascript
libraryDependencies += "xyz.felh" % "service" % "3.7.0304"
libraryDependencies += "xyz.felh" % "jtokkit" % "3.7.0304"
```
