...
[![GitHub version](https://img.shields.io/static/v1?label=version&message=v3.8.2024032101&color=blue)](https://github.com/forestwanglin/openai-java)
...
<dependency>
    ...
    <version>3.8.2024032101</version>
</dependency>
```
...
```yaml
implementation group: 'xyz.felh', name: 'service', version: '3.8.2024032101'
implementation group: 'xyz.felh', name: 'jtokkit', version: '3.8.2024032101'
```

### sbt

```javascript
libraryDependencies += "xyz.felh" % "service" % "3.8.2024032101"
libraryDependencies += "xyz.felh" % "jtokkit" % "3.8.2024032101"
```
