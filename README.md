...
[![GitHub version](https://img.shields.io/static/v1?label=version&message=v3.11.2024051301&color=blue)](https://github.com/forestwanglin/openai-java)
...
- [2024-04-21] Replace Assistants, Thread, Messages, Runs with new version on Apr 17th, 2024 in version `3.11.2024051301`
...
<dependency>
    ...
    <version>3.11.2024051301</version>
</dependency>
```
...
```yaml
implementation group: 'xyz.felh', name: 'service', version: '3.11.2024051301'
implementation group: 'xyz.felh', name: 'jtokkit', version: '3.11.2024051301'
```

### sbt

```javascript
libraryDependencies += "xyz.felh" % "service" % "3.11.2024051301"
libraryDependencies += "xyz.felh" % "jtokkit" % "3.11.2024051301"
```
