...
[![GitHub version](https://img.shields.io/static/v1?label=version&message=v1.9.1&color=blue)](https://github.com/forestwanglin/openai-java)
...
```yaml
implementation group: 'xyz.felh', name: 'service', version: '1.9.1'
implementation group: 'xyz.felh', name: 'jtokkit', version: '1.9.1'
```

### sbt

```javascript
libraryDependencies += "xyz.felh" % "service" % "1.9.1"
libraryDependencies += "xyz.felh" % "jtokkit" % "1.9.1"
```
