...
[![GitHub version](https://img.shields.io/static/v1?label=version&message=v2.6.0304&color=blue)](https://github.com/forestwanglin/openai-java)
...
```yaml
implementation group: 'xyz.felh', name: 'service', version: '2.6.0304'
implementation group: 'xyz.felh', name: 'jtokkit', version: '2.6.0304'
```

### sbt

```javascript
libraryDependencies += "xyz.felh" % "service" % "2.6.0304"
libraryDependencies += "xyz.felh" % "jtokkit" % "2.6.0304"
```
