...
[![GitHub version](https://img.shields.io/static/v1?label=version&message=v1.8.0&color=blue)](https://github.com/forestwanglin/openai-java)
...
```yaml
implementation group: 'xyz.felh', name: 'service', version: '1.8.0'
implementation group: 'xyz.felh', name: 'jtokkit', version: '1.8.0'
```

### sbt

```javascript
libraryDependencies += "xyz.felh" % "service" % "1.8.0"
libraryDependencies += "xyz.felh" % "jtokkit" % "1.8.0"
```
