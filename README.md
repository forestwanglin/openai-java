...
<dependency>
    ...
    <version>3.8.2024042101</version>
</dependency>
```
...
```yaml
implementation group: 'xyz.felh', name: 'service', version: '3.8.2024042101'
implementation group: 'xyz.felh', name: 'jtokkit', version: '3.8.2024042101'
```

### sbt

```javascript
libraryDependencies += "xyz.felh" % "service" % "3.8.2024042101"
libraryDependencies += "xyz.felh" % "jtokkit" % "3.8.2024042101"
```
